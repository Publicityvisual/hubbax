  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex font-sans selection:bg-[#d93025] selection:text-white">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 lg:px-12 relative">
        ...
        {/* Login Card - Large WoWonder Style */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="w-full max-w-[520px] bg-[#121212]/90 backdrop-blur-xl border border-white/10 rounded-3xl p-10 lg:p-12 shadow-2xl shadow-black/50"
        >
          {/* Card Header */}
          ...
          <div className="flex gap-4 mb-8">
            <button className="flex-1 flex items-center justify-center gap-3 h-16 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl text-white text-lg font-medium transition-all duration-200 hover:border-white/20 hover:scale-[1.02] active:scale-[0.98]">
          ...
          <div className="relative flex items-center mb-8">
            ...
            <span className="px-5 text-neutral-500 text-base font-medium">o continúa con email</span>
            <div className="flex-grow border-t border-white/10"></div>
          </div>

          {/* Login Form - Large Inputs */}
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              <Input 
                ...
                {...register('email')}
                className="h-16 bg-[#0A0A0A]/60 border-white/10 text-white text-lg placeholder:text-neutral-500 focus:bg-[#0A0A0A] focus:border-[#d93025] focus:ring-2 focus:ring-[#d93025]/20 rounded-2xl transition-all px-6"
                hideLabel
              />
            </div>
            <div>
            ...
            <div className="flex items-center justify-between py-2">
              <label className="flex items-center gap-3 cursor-pointer group">
                <input type="checkbox" className="w-5 h-5 rounded-lg border-white/20 bg-white/5 text-[#d93025] focus:ring-[#d93025]/20" />
                <span className="text-neutral-400 text-base group-hover:text-white transition-colors">Recordarme</span>
              </label>
              <Link to="/forgot-password" className="text-[#d93025] hover:text-[#ff6b5b] text-base font-semibold transition-colors">
            ...
            <Button 
              type="submit" 
              className="w-full h-16 text-xl font-bold rounded-2xl bg-gradient-to-r from-[#d93025] to-[#ff4444] hover:brightness-110 text-white transition-all shadow-xl shadow-[#d93025]/30 hover:shadow-[#d93025]/50 hover:-translate-y-0.5" 
              size="lg" 
              isLoading={isLoading}
            >
              {isLoading ? <Loader2 className="animate-spin w-6 h-6" /> : "Iniciar sesión"}
            </Button>
          </form>
          ...
          <div className="mt-10 pt-8 border-t border-white/10 text-center">
            <p className="text-neutral-400 text-lg">
              ...
              <button 
                ...
                className="text-[#d93025] hover:text-[#ff6b5b] font-bold transition-colors"
              >
                Regístrate gratis
              </button>
            </p>
