            ...
            <div className="login-form-container">
              <form className="login-form register-form" onSubmit={(e) => {
                ...
                {registerState?.error && (
                  <div className="error-message" role="alert">
                    <span className="error-indicator">❌</span>
                    {registerState.error === 'Todos los campos son requeridos' 
                      ? '¡Hey! Completa todos los campos para continuar 😊' 
                      : registerState.error === 'Las contraseñas no coinciden'
                      ? '🔑 Las contraseñas no coinciden. ¡Revísalas!'
                      : registerState.error === 'La contraseña debe tener al menos 6 caracteres'
                      ? '🔐 Tu contraseña necesita mínimo 6 caracteres para estar segura'
                      : registerState.error}
                  </div>
                )}
                {registerState?.success && (
