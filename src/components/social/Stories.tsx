...
const STORY_USERS: StoryUser[] = [
  MASTER_USERS.ai_assistant,
  {
    ...
    avatarImage: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150',
    storyImage: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=500&auto=format&fit=crop&q=60'
  },
  {
    username: 'john_w',
    fullName: 'John Wick',
    avatarImage: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=150',
    storyImage: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=500&auto=format&fit=crop&q=60'
  },
  {
    username: 'elena_f',
    fullName: 'Elena Fisher',
    avatarImage: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150',
    storyImage: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=500&auto=format&fit=crop&q=60'
  }
];
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 no-scrollbar px-0">
        ...
        <div className="relative flex-shrink-0 w-[112px] h-[200px] bg-[#242526] rounded-xl overflow-hidden cursor-pointer group shadow-lg hover:shadow-xl transition-all border border-white/5">
            ...
            <div className="absolute bottom-0 w-full p-2 flex flex-col items-center pb-3">
                 ...
                 <span className="text-white text-[13px] font-bold mt-1 text-center leading-tight">Crear historia</span>
            </div>
        </div>
        ...
        {STORY_USERS.map((user, i) => (
             <motion.div 
                ...
                className="relative flex-shrink-0 w-[112px] h-[200px] rounded-xl overflow-hidden cursor-pointer group bg-[#242526] border border-white/5 shadow-md"
             >
                <img 
